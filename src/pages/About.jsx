...
const About = () => {
  ...
  return (
    <div className="flex relative left-0  md:pl-[2rem] text-white">
        <div id="aboutPage" className="opacity-0 flex flex-col  lg2:flex-row">
            <div className="flex flex-col justify-center pl-[1rem] lg2:pl-[10rem] ">
                <div className="flex leading-[140%] text-[3.5rem] font-bold md:text-[5rem] lg2:leading-[120%]">
                    ...
                    <h1 id="about_M" className="text-white hover:text-teal-600 opacity-0 pl-2 lg2:pl-5 " >M</h1>
            ...
            <div id="aboutRight" className="opacity-0 flex justify-center items-center mt-[2rem] ml-[1rem] lg2:mt-[0rem]">
                <div>
                    ...
                    <img id="bodyShot" className=" border-2 border-white h-[30rem] md:h-[40rem] xl:block xl:ml-[10rem] " src={Matt} alt="selfie"/>
                </div>
            </div>
        </div>
    </div>
